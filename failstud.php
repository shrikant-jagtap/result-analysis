...
{
?>
<h1 style="text-align:center">Failed Students</h1>
<form action="failstud.php" method="post">
...
<input id="ro" type="submit" name="fail" value="Show">
...
if(isset($_POST['fail']))
{
$query_fail="SELECT * FROM student where roll_no IN (SELECT DISTINCT roll_no FROM student_exam WHERE result='F' AND exam_year='".$_POST['year']."' AND engg_year=".$_POST['engg_year']." AND sem_no=".$_POST['engg_year']."*2-1)";
//$sql_odd =  "SELECT * FROM student where roll_no IN (SELECT DISTINCT roll_no FROM student_exam WHERE result='F' AND exam_year='".$_POST['year']."' AND engg_year=".$_POST['engg_year']." AND sem_no=".$_POST['engg_year']."*2-1)";
$sql_even = "SELECT * FROM student where roll_no IN (SELECT DISTINCT roll_no FROM student_exam WHERE result='F' AND exam_year='".$_POST['year']."' AND engg_year=".$_POST['engg_year']." AND sem_no=".$_POST['engg_year']."*2)";
$result=mysql_query($query_fail);
?>
<table id="Fail" cellspacing="30">
  <tr>
   <th>Name</th>
   <th>Roll No</th>
    </tr>
...
echo "For ODD Sem : ".$ans;
$result=mysql_query($sql_even);
